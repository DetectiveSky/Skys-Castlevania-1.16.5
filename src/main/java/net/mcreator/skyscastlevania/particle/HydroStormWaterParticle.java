...
import net.mcreator.skyscastlevania.procedures.HydroStormWaterAdditionalParticleExpiryConditionProcedure;
...
public class HydroStormWaterParticle {
	public static final BasicParticleType particle = new BasicParticleType(false);

	@SubscribeEvent
	public static void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("hydro_storm_water"));
	}
	...
	private static class CustomParticle extends SpriteTexturedParticle {
		...
		public void tick() {
			...
			double y = this.posY;
			double z = this.posZ;
			if (HydroStormWaterAdditionalParticleExpiryConditionProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("onGround", onGround))
