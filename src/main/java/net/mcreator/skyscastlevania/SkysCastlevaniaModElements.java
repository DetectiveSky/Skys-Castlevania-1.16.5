...
public class SkysCastlevaniaModElements {
	...
	public SkysCastlevaniaModElements() {
		sounds.put(new ResourceLocation("skys_castlevania", "rhapsodyoftheforsaken"),
		...
		try {
			...
			for (ModFileScanData.AnnotationData annotationData : annotations) {
				if (annotationData.getAnnotationType().getClassName().equals(ModElement.Tag.class.getName())) {
					...
					if (clazz.getSuperclass() == SkysCastlevaniaModElements.ModElement.class)
						elements.add((SkysCastlevaniaModElements.ModElement) clazz.getConstructor(this.getClass()).newInstance(this));
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
		...
		elements.forEach(SkysCastlevaniaModElements.ModElement::initElements);
		MinecraftForge.EVENT_BUS.register(new SkysCastlevaniaModVariables(this));
	}
	...
	public <T> void addNetworkMessage(Class<T> messageType, BiConsumer<T, PacketBuffer> encoder, Function<PacketBuffer, T> decoder,
		...
		SkysCastlevaniaMod.PACKET_HANDLER.registerMessage(messageID, messageType, encoder, decoder, messageConsumer);
		messageID++;
	}
	...
	public static class ModElement implements Comparable<ModElement> {
		...
		protected final SkysCastlevaniaModElements elements;
		protected final int sortid;

		public ModElement(SkysCastlevaniaModElements elements, int sortid) {
