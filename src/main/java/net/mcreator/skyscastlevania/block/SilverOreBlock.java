...
public class SilverOreBlock extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:silver_ore")
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("skys_castlevania:silver_ore_match"),
