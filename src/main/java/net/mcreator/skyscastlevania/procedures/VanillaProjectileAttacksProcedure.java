...
public class VanillaProjectileAttacksProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				SkysCastlevaniaMod.LOGGER.warn("Failed to load dependency world for procedure VanillaProjectileAttacks!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				SkysCastlevaniaMod.LOGGER.warn("Failed to load dependency x for procedure VanillaProjectileAttacks!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				SkysCastlevaniaMod.LOGGER.warn("Failed to load dependency y for procedure VanillaProjectileAttacks!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				SkysCastlevaniaMod.LOGGER.warn("Failed to load dependency z for procedure VanillaProjectileAttacks!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				SkysCastlevaniaMod.LOGGER.warn("Failed to load dependency entity for procedure VanillaProjectileAttacks!");
			return;
		}
		if (dependencies.get("imediatesourceentity") == null) {
			if (!dependencies.containsKey("imediatesourceentity"))
				SkysCastlevaniaMod.LOGGER.warn("Failed to load dependency imediatesourceentity for procedure VanillaProjectileAttacks!");
			return;
		}
		if (dependencies.get("amount") == null) {
			if (!dependencies.containsKey("amount"))
				SkysCastlevaniaMod.LOGGER.warn("Failed to load dependency amount for procedure VanillaProjectileAttacks!");
			return;
		}
		...
		double multiplier = 0;
		if (EntityTypeTags.getCollection().getTagByID(new ResourceLocation("forge:projectile")).contains(imediatesourceentity.getType())
			...
			entity.setMotion(((-1) * Math.sin(imediatesourceentity.rotationYaw)), ((-1) * Math.sin(imediatesourceentity.rotationPitch)),
					Math.cos(imediatesourceentity.rotationYaw));
		}
	}
}
