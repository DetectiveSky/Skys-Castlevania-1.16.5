...
import net.mcreator.skyscastlevania.entity.renderer.ThrowingAxeIronRenderer;
...
public class ThrowingAxeIronItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:throwing_axe_iron")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletthrowing_axe_iron").setRegistryName("entitybulletthrowing_axe_iron");

	public ThrowingAxeIronItem(SkysCastlevaniaModElements instance) {
		super(instance, 49);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ThrowingAxeIronRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("throwing_axe_iron");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			IronTAxeBulletHitsEntityProcedure.executeProcedure(
