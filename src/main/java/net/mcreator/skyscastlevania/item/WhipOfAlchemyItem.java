...
public class WhipOfAlchemyItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:whip_of_alchemy")
	public static final Item block = null;

	public WhipOfAlchemyItem(SkysCastlevaniaModElements instance) {
		super(instance, 33);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Rinoldo Gandolfi's masterpiece, infused with alchemical power."));
			}
		}.setRegistryName("whip_of_alchemy"));
	}

	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxDamage(1000));
		}
