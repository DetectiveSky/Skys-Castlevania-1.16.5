...
import net.mcreator.skyscastlevania.procedures.NetheriteCrossBulletHitsEntityProcedure;
import net.mcreator.skyscastlevania.procedures.CrossSWepWhileBulletFlyingTickProcedure;
import net.mcreator.skyscastlevania.procedures.CrossSWepBulletHitsPlayerProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.NetheriteCrossRenderer;
...
public class NetheriteCrossItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:netherite_cross")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxDamage(2031));
			setRegistryName("netherite_cross");
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (CanUseSubweaponProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
						(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll))) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity, e -> e.getItem() == HeartItem.block);
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == HeartItem.block) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.5f, 0.1, 1);
						itemstack.damageItem(1, entity, e -> e.sendBreakAnimation(entity.getActiveHand()));
						if (entity.abilities.isCreativeMode) {
							entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.CREATIVE_ONLY;
						} else {
							if (new ItemStack(HeartItem.block).isDamageable()) {
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedNetheriteCrossItem.block);
		}
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			CrossSWepBulletHitsPlayerProcedure.executeProcedure(Stream
		...
		protected void arrowHit(LivingEntity entity) {
			...
			NetheriteCrossBulletHitsEntityProcedure.executeProcedure(Stream
		...
		public void tick() {
			...
			CrossSWepWhileBulletFlyingTickProcedure.executeProcedure(Stream
