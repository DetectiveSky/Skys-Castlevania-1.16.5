...
public class AlucardSwordItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:alucard_sword")
	...
	public void initElements() {
		...
		}, 3, -2f, new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab)) {
			@Override
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				super.addInformation(itemstack, world, list, flag);
				list.add(new StringTextComponent("A family heirloom of Alucard's."));
				list.add(new StringTextComponent("He prefers it over any other."));
			}
		}.setRegistryName("alucard_sword"));
	}
}
