...
public class BlueStoneItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:blue_stone")
	public static final Item block = null;

	public BlueStoneItem(SkysCastlevaniaModElements instance) {
		super(instance, 9);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Infuses the Vampire Killer with the power of Ice."));
		}
	}
}
