...
import net.mcreator.skyscastlevania.procedures.NetheriteTAxeHitsLivingEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.ThrowingAxeNetheriteRenderer;
...
public class ThrowingAxeNetheriteItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:throwing_axe_netherite")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("throwing_axe_netherite");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedNetheriteAxeItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			NetheriteTAxeHitsLivingEntityProcedure.executeProcedure(Stream
