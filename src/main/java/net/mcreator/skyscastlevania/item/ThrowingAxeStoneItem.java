...
import net.mcreator.skyscastlevania.procedures.StoneTAxeBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.ThrowingAxeStoneRenderer;
...
public class ThrowingAxeStoneItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:throwing_axe_stone")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletthrowing_axe_stone").setRegistryName("entitybulletthrowing_axe_stone");

	public ThrowingAxeStoneItem(SkysCastlevaniaModElements instance) {
		super(instance, 48);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ThrowingAxeStoneRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("throwing_axe_stone");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (CanUseSubweaponProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.5f, 0.1, 2);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedStoneAxeItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			StoneTAxeBulletHitsEntityProcedure.executeProcedure(Stream
