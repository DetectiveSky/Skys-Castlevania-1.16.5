...
import net.mcreator.skyscastlevania.procedures.HolyWaterBulletHitsBlockProcedure;
import net.mcreator.skyscastlevania.procedures.CreativeHolyWaterBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.HolyWaterSWepRenderer;
...
public class HolyWaterSWepItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:holy_water_s_wep")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("holy_water_s_wep");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Creative Mode version of Holy Water subweapon"));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(HolyWaterSWepItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			CreativeHolyWaterBulletHitsEntityProcedure.executeProcedure(Stream
		...
		public void tick() {
			...
			if (this.inGround) {
				...
				HolyWaterBulletHitsBlockProcedure.executeProcedure(Stream
