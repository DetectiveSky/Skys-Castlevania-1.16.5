...
import net.mcreator.skyscastlevania.procedures.DiamondDaggerBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.DiamondDaggerRenderer;
...
public class DiamondDaggerItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:diamond_dagger")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(DiamondDaggerItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			DiamondDaggerBulletHitsEntityProcedure.executeProcedure(Stream
