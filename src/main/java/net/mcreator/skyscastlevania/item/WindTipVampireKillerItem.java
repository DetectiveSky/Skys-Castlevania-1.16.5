...
public class WindTipVampireKillerItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:wind_tip_vampire_killer")
	public static final Item block = null;

	public WindTipVampireKillerItem(SkysCastlevaniaModElements instance) {
		super(instance, 317);
	}
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Imbued with the power of wind."));
			}
		}.setRegistryName("wind_tip_vampire_killer"));
	}
