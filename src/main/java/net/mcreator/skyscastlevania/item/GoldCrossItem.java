...
import net.mcreator.skyscastlevania.procedures.GoldCrossBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.GoldCrossRenderer;
...
public class GoldCrossItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:gold_cross")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedGoldCrossItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			GoldCrossBulletHitsEntityProcedure.executeProcedure(Stream
