...
import net.mcreator.skyscastlevania.procedures.WoodenCrossBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.WoodCrossRenderer;
...
public class WoodCrossItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:wood_cross")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxDamage(59));
			setRegistryName("wood_cross");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedWoodCrossItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			WoodenCrossBulletHitsEntityProcedure.executeProcedure(Stream
