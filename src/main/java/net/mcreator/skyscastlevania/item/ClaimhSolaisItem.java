...
public class ClaimhSolaisItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:claimh_solais")
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Blocks.GLOWSTONE));
			}
		}, 3, -2.2f, new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab)) {
			@Override
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				super.addInformation(itemstack, world, list, flag);
				list.add(new StringTextComponent("An indefatigable sword whose blade shines with light."));
			}
		}.setRegistryName("claimh_solais"));
	}
}
