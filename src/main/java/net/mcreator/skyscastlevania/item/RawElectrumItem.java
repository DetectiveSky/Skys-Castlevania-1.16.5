...
public class RawElectrumItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:raw_electrum")
	public static final Item block = null;

	public RawElectrumItem(SkysCastlevaniaModElements instance) {
		super(instance, 314);
	}
