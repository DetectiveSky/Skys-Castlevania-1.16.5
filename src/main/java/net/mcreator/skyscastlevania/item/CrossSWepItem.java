...
import net.mcreator.skyscastlevania.procedures.CrossSWepBulletHitsLivingEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.CrossSWepRenderer;
...
public class CrossSWepItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:cross_s_wep")
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Creative Mode version of Cross subweapon"));
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (CanUseSubweaponProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.5f, 10, 5);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedCrossItem.block);
		}
