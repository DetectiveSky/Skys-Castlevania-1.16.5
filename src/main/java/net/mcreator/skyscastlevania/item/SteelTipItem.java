...
public class SteelTipItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:steel_tip")
	public static final Item block = null;

	public SteelTipItem(SkysCastlevaniaModElements instance) {
		super(instance, 7);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Increases the force of the Vampire Killer at the cost of its cutting edge."));
		}
	}
}
