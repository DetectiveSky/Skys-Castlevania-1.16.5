...
import net.mcreator.skyscastlevania.procedures.AxeSWepBulletHitsLivingEntityProcedure;
import net.mcreator.skyscastlevania.itemgroup.SkysCastlevaniaTabItemGroup;
import net.mcreator.skyscastlevania.entity.renderer.AxeSWepRenderer;
...
public class AxeSWepItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:axe_s_wep")
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Creative Mode version of the Axe subweapon"));
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (CanUseSubweaponProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 0.1, 5);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedAxeItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			AxeSWepBulletHitsLivingEntityProcedure.executeProcedure(Stream
