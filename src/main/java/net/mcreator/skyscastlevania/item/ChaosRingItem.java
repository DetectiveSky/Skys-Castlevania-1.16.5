...
public class ChaosRingItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:chaos_ring")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxStackSize(1).isImmuneToFire().rarity(Rarity.EPIC));
			setRegistryName("chaos_ring");
		}
