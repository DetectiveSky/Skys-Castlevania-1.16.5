...
public class MidasTouchItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:midas_touch")
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("The severed and preserved hand of King Midas of Crete."));
			}
	...
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxDamage(500));
		}
