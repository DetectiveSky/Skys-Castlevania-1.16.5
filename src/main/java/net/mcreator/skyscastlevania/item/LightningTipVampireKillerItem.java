...
public class LightningTipVampireKillerItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:lightning_tip_vampire_killer")
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Imbued with the power of lightning."));
			}
		}.setRegistryName("lightning_tip_vampire_killer"));
	}
