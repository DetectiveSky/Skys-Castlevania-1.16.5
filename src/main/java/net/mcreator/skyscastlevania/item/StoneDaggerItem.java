...
import net.mcreator.skyscastlevania.procedures.StoneDaggerBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.StoneDaggerRenderer;
...
public class StoneDaggerItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:stone_dagger")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(StoneDaggerItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			StoneDaggerBulletHitsEntityProcedure.executeProcedure(Stream
