...
public class SteelTipVampireKillerItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:steel_tip_vampire_killer")
	...
	public void initElements() {
		elements.items.add(() -> new ItemToolCustom() {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Tipped with a steel ball."));
			}
		}.setRegistryName("steel_tip_vampire_killer"));
	}
