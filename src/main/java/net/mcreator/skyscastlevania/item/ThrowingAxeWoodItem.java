...
import net.mcreator.skyscastlevania.procedures.WoodTAxeBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.ThrowingAxeWoodRenderer;
...
public class ThrowingAxeWoodItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:throwing_axe_wood")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletthrowing_axe_wood").setRegistryName("entitybulletthrowing_axe_wood");

	public ThrowingAxeWoodItem(SkysCastlevaniaModElements instance) {
		super(instance, 47);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ThrowingAxeWoodRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("throwing_axe_wood");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedWoodenAxeItem.block);
		}
