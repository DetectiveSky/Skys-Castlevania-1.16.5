...
import net.mcreator.skyscastlevania.procedures.HolyWaterBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.HolyWaterRenderer;
...
public class HolyWaterItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:holy_water")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletholy_water").setRegistryName("entitybulletholy_water");

	public HolyWaterItem(SkysCastlevaniaModElements instance) {
		super(instance, 32);
		FMLJavaModLoadingContext.get().getModEventBus().register(new HolyWaterRenderer.ModelRegisterHandler());
	}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		protected void arrowHit(LivingEntity entity) {
			...
			HolyWaterBulletHitsEntityProcedure.executeProcedure(Stream
