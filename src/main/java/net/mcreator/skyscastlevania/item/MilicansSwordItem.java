...
public class MilicansSwordItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:milicans_sword")
	...
	public void initElements() {
		elements.items.add(() -> new SwordItem(new IItemTier() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(Blocks.STONE), new ItemStack(Blocks.GRANITE), new ItemStack(Blocks.DIORITE),
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Occasionally petrifies those it hits."));
			}
		}.setRegistryName("milicans_sword"));
	}
}
