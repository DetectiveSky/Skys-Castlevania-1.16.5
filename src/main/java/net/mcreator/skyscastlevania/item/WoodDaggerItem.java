...
import net.mcreator.skyscastlevania.procedures.WoodDaggerBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.WoodDaggerRenderer;
...
public class WoodDaggerItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:wood_dagger")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(WoodDaggerItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			WoodDaggerBulletHitsEntityProcedure.executeProcedure(Stream
