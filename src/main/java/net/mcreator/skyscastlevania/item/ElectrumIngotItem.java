...
public class ElectrumIngotItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:electrum_ingot")
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("A naturally-occurring alloy of gold and silver."));
		}
	}
}
