...
import net.mcreator.skyscastlevania.procedures.GoldDaggerBulletHitsLivingEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.GoldDaggerRenderer;
...
public class GoldDaggerItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:gold_dagger")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(GoldDaggerItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			GoldDaggerBulletHitsLivingEntityProcedure.executeProcedure(Stream
