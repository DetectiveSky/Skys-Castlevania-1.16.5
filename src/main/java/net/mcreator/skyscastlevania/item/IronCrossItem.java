...
import net.mcreator.skyscastlevania.procedures.IronCrossBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.IronCrossRenderer;
...
public class IronCrossItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:iron_cross")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxDamage(250));
			setRegistryName("iron_cross");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedIronCrossItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			IronCrossBulletHitsEntityProcedure.executeProcedure(Stream
