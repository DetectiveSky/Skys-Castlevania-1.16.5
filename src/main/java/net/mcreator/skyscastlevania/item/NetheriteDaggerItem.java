...
import net.mcreator.skyscastlevania.procedures.NetheriteDaggerBulletHitsLivingEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.NetheriteDaggerRenderer;
...
public class NetheriteDaggerItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:netherite_dagger")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(NetheriteDaggerItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			NetheriteDaggerBulletHitsLivingEntityProcedure.executeProcedure(Stream
		...
		public void tick() {
			...
			DaggerIsFreeProcedure.executeProcedure(Stream
