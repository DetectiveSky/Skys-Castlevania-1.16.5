...
import net.mcreator.skyscastlevania.procedures.UncursePotionFoodEatenProcedure;
...
public class UncursePotionItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:uncurse_potion")
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxStackSize(16).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(0).saturation(0f).setAlwaysEdible()
							...
							.build()));
			setRegistryName("uncurse_potion");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Cures Curse."));
		}
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			UncursePotionFoodEatenProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
