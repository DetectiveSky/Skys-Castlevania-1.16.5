...
import net.mcreator.skyscastlevania.procedures.StoneCrossBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.StoneCrossRenderer;
...
public class StoneCrossItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:stone_cross")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxDamage(131));
			setRegistryName("stone_cross");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedStoneCrossItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			StoneCrossBulletHitsEntityProcedure.executeProcedure(Stream
