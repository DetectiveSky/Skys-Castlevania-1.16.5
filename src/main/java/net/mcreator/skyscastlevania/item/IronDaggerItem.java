...
import net.mcreator.skyscastlevania.procedures.IronDaggerBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.IronDaggerRenderer;
...
public class IronDaggerItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:iron_dagger")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(IronDaggerItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			IronDaggerBulletHitsEntityProcedure.executeProcedure(Stream
