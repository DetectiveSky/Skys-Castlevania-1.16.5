...
import net.mcreator.skyscastlevania.entity.renderer.DaggerSWepRenderer;
...
public class DaggerSWepItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:dagger_s_wep")
	...
	public static class ItemRanged extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Creative Mode version of Dagger subweapon"));
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(DaggerSWepItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			DaggerSWepBulletHitsLivingEntityProcedure.executeProcedure(Stream
