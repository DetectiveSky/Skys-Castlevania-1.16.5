...
public class SoundItem3Item extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:sound_item_3")
	...
	public static class MusicDiscItemCustom extends MusicDiscItem {
		public MusicDiscItemCustom() {
			super(0, SkysCastlevaniaModElements.sounds.get(new ResourceLocation("skys_castlevania:subterraneanhell")),
					new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxStackSize(1).rarity(Rarity.RARE));
			setRegistryName("sound_item_3");
		}
