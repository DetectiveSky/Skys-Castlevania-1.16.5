...
import net.mcreator.skyscastlevania.procedures.DiamondCrossBulletHitsEntityProcedure;
...
import net.mcreator.skyscastlevania.entity.renderer.DiamondCrossRenderer;
...
public class DiamondCrossItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:diamond_cross")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(SkysCastlevaniaTabItemGroup.tab).maxDamage(1561));
			setRegistryName("diamond_cross");
		}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AnimatedDiamondCrossItem.block);
		}
		...
		protected void arrowHit(LivingEntity entity) {
			...
			DiamondCrossBulletHitsEntityProcedure.executeProcedure(Stream
