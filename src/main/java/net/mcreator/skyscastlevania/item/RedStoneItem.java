...
public class RedStoneItem extends SkysCastlevaniaModElements.ModElement {
	@ObjectHolder("skys_castlevania:red_stone")
	public static final Item block = null;

	public RedStoneItem(SkysCastlevaniaModElements instance) {
		super(instance, 8);
	}
